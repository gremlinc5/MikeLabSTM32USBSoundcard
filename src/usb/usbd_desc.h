...
#define USBD_BB_IF_STR_DESC           (uint8_t *)"MikeLabCard"
#define USBD_BB_URL_STR_DESC          (uint8_t *)"MikeLab"
#define USBD_BB_ALTMODE0_STR_DESC     (uint8_t *)"MikeLab Alternate0 Mode"
#define USBD_BB_ALTMODE1_STR_DESC     (uint8_t *)"MikeLab Alternate1 Mode"
#endif
